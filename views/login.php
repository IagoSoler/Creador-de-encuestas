...
<body>
    ...
    <main>
        <section>
            ...
            <form method="post">
                <!--Al pulsar el botón submit del formulario, se enviarán los dato a la página actual por el método "post"-->
            ...
            <?php endif; ?>
            <p>¿No tienes usuario? <a href="register.php">Regístrate</a></p>
            <!--Alternativamente, se podrá pulsar en este enlace que llevará a la página de registro-->
        </section>
        <br>
        <br>
        <section style="background-color: red;" style="background-color: red;">
            <p>Importante: El autor no se responsabiliza ni garantiza la seguridad de los datos que los usuarios
                faciliten.</p>
            <p>Esta aplicación tiene un mero carácter demostrativo. </p>
            <p> Las encuestas y datos guardados en las BBDD no deberían contener información privada o delicada.</p>
            <p>Además, los datos podrán ser borrados en mantenimientos y actualizaciones</p>
        </section>
    </main>
