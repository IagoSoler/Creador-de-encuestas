...
<head>
    ...
    <!--Diseño responsive para que se adapte al dispositivo--->
...
<body>
    ...
    <main>
        ...
        <section class="MainMenu">
            ...
            <h3>Crear una nueva encuesta:</h3>
            <button class="OtherButtons" onclick="window.location.href='create_survey.php'">Crear nueva
                encuesta</button>

            <!--En este formulario se puede introducir un código facilitado por un creador o participante para agregar y responder una encuesta, que entonces aparecerá en la tabla-->

        </section>
        <section>
            <h2>O consulta tus encuestas:</h2>
            <!--Se crea una tabla donde se listarán las encuestas con cierta información y botones.-->
            <div class="surveys-table-container">
                <?php if (!$surveys) {
                    echo "No has participado en ninguna encuesta";
                } else { ?>
                        ...
                        <thead>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>Resultados</th>
                                    <th>Estado</th>
                                    <th>Compartir <span id="infoSpan" title="Comparte o copia este enlace en la barra de búsqueda con una sesión iniciada para responder la encuesta. Cualquier usuario que haya participado podrá compartirla y ver los resultados.">?</span></th>
                                    <th>Eliminar</th>
                                </tr>
                                </thead>
                            </tr>
                        ...
                        <tbody>
                            ...
                            foreach ($surveys as $survey): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            href="results.php?survey_id=<?php echo $survey['id']; ?>">Ver</a><!--Enlace para ver los resultados-->
                                    </td>
                                    <td>
                                        <?php if ($survey['current_state'] == "cerrada") {
                                            echo "Cerrada";//Mostrará el estado cerrado y si la fecha de cierre es anterior a la actual.
                                                ...
                                                <form method="post">
                                                    <!--Si no la ha respondido, se muestra en botón que lleva responderla, incluyendo el ID en la URL-->
                                    ...
                                    <td>
                                        <!--En la celda de compartir, se copia, mediante "onclick", el link de la encuesta, que permitirá compartirla a nuevos participantes-->
                                        <button class="OtherButtons"
                                            onclick="navigator.clipboard.writeText('http://<?php echo $_SERVER['HTTP_HOST']; ?>/encuestas/views/answer_survey.php?survey_id=<?php echo $survey['id']; ?>')">
                                            Copiar enlace
                                        </button>
